...
questions.push(
  ...
  fillIn(2, 2, '基礎', "I ___ not like math.", '一般動詞の否定。___は？', ["don't", 'am', 'is'], 0, [{ en: 'math', ja: '数学' }]),
  ...
  fillIn(2, 2, '基礎', "She ___ not play tennis.", '三単現の否定。___は？', ["doesn't", 'is', "don't"], 0, [{ en: 'tennis', ja: 'テニス' }]),
  ...
  fillIn(2, 2, '応用', "We ___ not go to school on Sunday.", '___に入るのは？', ["don't", 'are', 'is'], 0, [{ en: 'Sunday', ja: '日曜日' }]),
  ...
  fillIn(2, 2, '発展', "My brother ___ not use a computer.", '三単現の否定。___は？', ["doesn't", "don't", 'is'], 0, [{ en: 'computer', ja: 'パソコン' }]),
...
questions.push(
  ...
  fillIn(2, 3, '基礎', "He ___ not drink milk.", '___に入るのは？', ["doesn't", 'is', "don't"], 0, [{ en: 'milk', ja: '牛乳' }]),
  ...
  fillIn(2, 3, '応用', "You ___ not need a pen.", '___に入るのは？', ["don't", 'are', 'is'], 0, [{ en: 'need', ja: '必要とする' }]),
  ...
  fillIn(2, 3, '発展', "It ___ not rain much here.", '___に入るのは？', ["doesn't", "don't", 'is'], 0, [{ en: 'rain', ja: '雨が降る' }]),
